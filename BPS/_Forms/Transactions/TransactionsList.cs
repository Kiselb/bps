...
namespace BPS
{
	...
	public class TransactionsList : System.Windows.Forms.Form
	{
        ...
        private BPS.BLL.Transactions.DataSets.dsUListOrgs dsUListOrgs1;
		private BPS.BLL.Transactions.DataSets.dsUListOrgsAccounts dsUListOrgsAccounts1;
        ...
        private BPS.BLL.Transactions.DataSets.dsTransSumList dsTransSumList1;
		...
		private void fillDGCurrSum()
		{
			...
			{
                BPS.BLL.Transactions.DataSets.dsTransSumList.TransSumListRow rw = (BPS.BLL.Transactions.DataSets.dsTransSumList.TransSumListRow)this.dvTransSumList.Table.NewRow();
		...
		private void InitializeComponent()
		{
            ...
            this.dsUListOrgs1 = new BPS.BLL.Transactions.DataSets.dsUListOrgs();
            ...
            this.dsUListOrgsAccounts1 = new BPS.BLL.Transactions.DataSets.dsUListOrgsAccounts();
            ...
            this.dsTransSumList1 = new BPS.BLL.Transactions.DataSets.dsTransSumList();
...
/// <returns></returns>
		...
		private void getTransSum()
		{
			...
			{
                BPS.BLL.Transactions.DataSets.dsTransSumList.TransSumListRow rwSum = (BPS.BLL.Transactions.DataSets.dsTransSumList.TransSumListRow)this.dvTransSumList[i].Row;
				rwSum.Sum = 0;
