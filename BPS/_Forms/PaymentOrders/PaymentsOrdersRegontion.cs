...
namespace BPS._Forms
{
	...
	public class PaymentsOrdersRecognition : System.Windows.Forms.Form
	{
		...
		private BPS.BLL.AccountStatemets.DataSets.dsAccStatementsList dsAccStatementsList1;
        ...
        private BPS.BLL.PaymentOrders.DataSets.dsOrgsUList dsOrgsUList1;
        ...
        private BPS.BLL.PaymentOrders.DataSets.dsOrgAccountsUList dsOrgAccountsUList1;
        ...
        private BPS.BLL.AccountStatemets.DataSets.dsAccStatementsListDetails dsAccStatementsListDetails1;
        ...
        private BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked dsRequestsNotLinked1;
		...
		private void InitializeComponent()
		{
            ...
            this.dsAccStatementsList1 = new BPS.BLL.AccountStatemets.DataSets.dsAccStatementsList();
			...
			this.dsOrgsUList1 = new BPS.BLL.PaymentOrders.DataSets.dsOrgsUList();
			this.cmbOrgAccount = new System.Windows.Forms.ComboBox();
			this.dvOrgAccountsUList = new System.Data.DataView();
            this.dsOrgAccountsUList1 = new BPS.BLL.PaymentOrders.DataSets.dsOrgAccountsUList();
            ...
            this.dsAccStatementsListDetails1 = new BPS.BLL.AccountStatemets.DataSets.dsAccStatementsListDetails();
            ...
            this.dsRequestsNotLinked1 = new BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked();
		...
		private void CurrentPaymentOrderChanged(object sender, System.EventArgs e) 
		{
			...
			{
				BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow rw = 
					(BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow)((DataRowView)bm.Current).Row;
		...
		private void CurrentRequestChanged(object sender, System.EventArgs e) 
		{
			...
			{
                BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow rw =
                    (BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow)((DataRowView)bm.Current).Row;
		...
		private void LinkSet() 
		{
            ...
            BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow rwRequest =
                (BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow)((DataRowView)bmRequests.Current).Row;
			
			BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow  rwPaym = 
				(BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow)((DataRowView)bmPayms.Current).Row;
		...
		private void showPaymentsOrdersHistory()
		{
			...
			if (this.tabControl1.SelectedIndex ==0) 
			{
				...
				BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow rw1 = (BLL.AccountStatemets.DataSets.dsAccStatementsListDetails.GetPaymentsOrdersRow) ((DataRowView) bm.Current).Row;
