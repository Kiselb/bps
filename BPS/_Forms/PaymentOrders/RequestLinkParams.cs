...
namespace BPS._Forms
{
	...
	public class RequestLinkParams : System.Windows.Forms.Form
	{
        ...
        public RequestLinkParams(BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow rwRequest)
		{
			//
        ...
        private void getServiceCharge(BPS.BLL.PaymentOrders.DataSets.dsRequestsNotLinked.GetRequestsNotLinkedRow rwRequest)
		{
