...
namespace BPS._Reports {
    ...
    public class CreditOperations : ReportClass {
    ...
    public class CachedCreditOperations : Component, ICachedReport {
        
        public CachedCreditOperations() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CreditOperations rpt = new CreditOperations();
            rpt.Site = this.Site;
            return rpt;
        }
