...
namespace BPS._Forms
{
	...
	public class AccountStatementPaymentEdit : System.Windows.Forms.Form
	{
		...
		private BPS._Forms.dsPaymentOrderListX.AccountsStatementsRow rwe;
		private BPS._Forms.dsPaymentOrderListX dsPaymList;
		...
		public AccountStatementPaymentEdit(BPS._Forms.dsPaymentOrderListX.AccountsStatementsRow rw, bool isAdding, bool isInPaym)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		public BPS._Forms.dsPaymentOrderListX DsPaymsList
		{
...
//			if ((this.cmbOrgFrom.SelectedValue = App.ShowAddOrg("", szINN)) == null)
		...
		private void getPOOrgName()
		{
			...
			BPS.BLL.Orgs.DataSets.dsOrgsAccount ds = (BPS.BLL.Orgs.DataSets.dsOrgsAccount)App.DsOrgsAccount.Copy();
...
//				DataRow [] dr = App.bllBank.DataSet.Banks.Select("BankID=" + dv[iNdex]["BankID"].ToString());//.cmbOrgAccount.SelectedValue);
		...
		private void ins_updPayment(BPS._Forms.dsPaymentOrderListX.AccountsStatementsRow rw )
		{
			BindingManagerBase bm = (BindingManagerBase)this.BindingContext[this.dataView1];
			BPS.BLL.Orgs.DataSets.dsOrgsAccount.OrgsAccountsRow rowOrg = (BPS.BLL.Orgs.DataSets.dsOrgsAccount.OrgsAccountsRow)((DataRowView)bm.Current).Row;
