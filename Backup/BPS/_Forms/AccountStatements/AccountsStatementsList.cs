...
namespace BPS._Forms
{
	...
	public class AccountsStatementsList : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AccountsStatementsList));
			...
			this.dsAccountsStatementsList1 = new BPS.BLL.AccountStatements.dsAccountsStatementsList();
			...
			this.ucPeriod1._DateFrom = new System.DateTime(2004, 1, 24, 0, 0, 0, 0);
			this.ucPeriod1._DateTill = new System.DateTime(2004, 1, 24, 0, 0, 0, 0);
			...
			// Confirmed
			// 
			this.Confirmed.FalseValue = false;
			this.Confirmed.HeaderText = "Принята";
			this.Confirmed.MappingName = "Confirmed";
			this.Confirmed.NullText = "-";
			this.Confirmed.NullValue = ((object)(resources.GetObject("Confirmed.NullValue")));
			this.Confirmed.TrueValue = true;
			...
			this.dataGridV2.Size = new System.Drawing.Size(856, 271);
			...
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@HeaderDateFrom", System.Data.SqlDbType.DateTime, 8));
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@HeaderDateTill", System.Data.SqlDbType.DateTime, 8));
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@OrgAccountID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, "0"));
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@OrgID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, "0"));
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@UserID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, "0"));
			// 
			// sqlConnection1
			// 
			...
			this.sqlDeleteCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@HeaderID", System.Data.SqlDbType.Int, 4));
			// 
			// mainMenu1
			// 
			...
			this.panel2.Size = new System.Drawing.Size(856, 511);
			...
			this.panel4.Size = new System.Drawing.Size(856, 271);
		...
		private bool validateAccountStatement(BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow rw)
		{
			if(rw.SaldoStart < 0)
			{
 ...
 * 		private void confirmedHeader1()
		...
		*/
		...
		private void editHeader()
		{
			...
			BindingManagerBase bm = (BindingManagerBase) this.BindingContext[this.dvAccountsStatementsHeaders];
			BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow rwTemp = (BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow)((DataRowView)bm.Current).Row;
		...
		private void ChangedBindingContext(object sender, EventArgs e)
		{
			...
			BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow rw = (BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow)((DataRowView)bm.Current).Row;
			this.m_HeaderRow =  (BPS.BLL.AccountStatements.dsAccountsStatementsList.AccountsStatementsHeadersRow)((DataRowView)bm.Current).Row;
